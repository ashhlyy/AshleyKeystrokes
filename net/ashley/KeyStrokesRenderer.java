...
import net.ashley.util.GraphicUtil;
...
public class KeyStrokesRenderer {
    ...
    public void renderKeyStrokes() {
        ...
        String text = this.keyStrokesMod.getAttackTimes().size() + " CPS";
        ...
        int insideRectHorizontal = (int) (spaceBarHorizontal * 0.4);

        int insideRectGapHor = (spaceBarHorizontal - insideRectHorizontal) / 2;
        int insideRectGapVer = (spaceBarVertical - gap) / 2;
